...
for i in list[3:end]
    ...
    #---- For NIKON :----- (AND also for Hirox with bottom light)
    ...
    bt = BlobTracker(7:11, #array of blob sizes we want to detect --> era 5 e 11 poer Hirox, 7:11 x 3um Nikon, tr2 H2O2: 3:1, tr3 cambia noise2 to 15 tr4 noise2 to 20. Per Nikon alla fine 5:6
